...
public class CalculadoraDescontos {
    ...
    System.out.println("O desconto será de " +percentualDesconto + "%"); //REGRA DE TRÊS PARA DESCOBRIR QUAL O VALOR DO DESCONTO.
    double desconto = precoProduto * percentualDesconto / 100;
    double precoComDesconto = precoProduto - desconto; //PREÇO DO PRODUTO MENOS O DESCONTO PARA SABERMOS O VALOR DO PRODUTO COM O DESCONTO QUE FOI CALCULADO NA LINHA ANTERIOR
